...
public class OrcamentoCController implements Initializable {
    @FXML
    public TextField nifInput;
    @FXML
    public TextField codFuncionarioInput;
    @FXML
    public TextField codPedidoDeOrcamentoInput;
    @FXML
    ...
    private void showModalWithController(String fxmlName,String title, VerPassoController c){
        try {
            ...
            scene.getStylesheets().add(String.valueOf(OrcamentoController.class.getResource("/css/style.css")));
            ...
            private final Button seeButton = new Button("Ver");
            {
                seeButton.setOnAction(event -> {
                    ...
                    VerPassoController c = new VerPassoController(
                            this.getTableRow().getItem().descricao.getValue(),
                            this.getTableRow().getItem().custo.getValue(),
                            this.getTableRow().getItem().previsaoTempo.getValue()
                    );
